...
# print(type(X))
# print(X.shape)                                              #separate data into input and output features
# X_train,X_test,Y_train,Y_test = train_test_split(X, Y, test_size = 0.2)
# print(X_train.shape)           #split data into train and test sets in 80-20 ratio
# layer_sizes = [13, 256, 1]                                                       #set layer sizes, do not change the size of the first and last layer 
